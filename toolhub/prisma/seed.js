...
async function main() {
  ...
  const pages = [
    { slug: "home", title: "Home", seoTitle: "ToolHub — Ultimate Tools Collection",
      ...
      blocks: homeBlocks() },
    { slug: "windows", title: "Windows Tools", seoDescription: "System utilities and productivity tools for Windows.",
    ...
    { slug: "game", title: "Game Tools", seoDescription: "Utilities and tools for your favourite games.",
    ...
    { slug: "roblox", title: "Roblox Tools", seoDescription: "Studio helpers and utilities for Roblox creators.",
    ...
    { slug: "crypto", title: "Crypto Tools", seoDescription: "Wallets, analytics and trading utilities.",
    ...
    { slug: "faq", title: "Frequently Asked Questions", seoDescription: "Answers to common questions about the ToolHub catalog.",
    ...
    { slug: "about", title: "About ToolHub", seoDescription: "Why ToolHub exists and how the catalog is maintained.",
      blocks: [
