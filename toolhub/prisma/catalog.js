...
export const CATALOG = [
  {
    ...
    short: "Popular Windows cleanup and optimization utility.",
    long: "CCleaner helps remove temporary files, clean up storage and manage common Windows maintenance tasks.",
    features: ["Junk file cleanup", "Privacy cleanup", "Startup management", "Registry tools"],
    requirements: ["Windows 10 or 11"]
  },

  {
    name: "Xeno Executor",
    category: "roblox-executors",
    sub: "Executors",
    price: "Free",
    site: "xeno.now",
    version: "1.3.60",
    ...
    long: "Xeno Executor is a third-party Windows utility associated with Roblox script execution. Roblox client updates can break compatibility and third-party executors can result in account action.",
    features: [
  ...
  {
    name: "Velocity Executor",
    category: "roblox-executors",
    sub: "Executors",
    price: "Free",
    site: "getvelocity.org",
    version: "0.8.2",
    size: "—",
    rating: 4.1,
    downloads: 52100,
    ...
    features: [
      "Lua script execution",
      "Roblox client version tracking",
      "Release changelog",
      "Windows workflow",
      "Compatibility-focused updates"
    ],
    requirements: [
      "Windows 10 or 11",
      "Roblox installed",
...

  {
    ...
    features: [
      "External menu architecture",
      "Configurable interface",
      "Version tracking",
      "Changelog metadata",
      "GTA V compatibility notes"
    ],
    requirements: [
      "Windows 10 or 11",
      "GTA V for PC",
      "Use only where third-party modifications are permitted"
    ]
  },

  {
    ...
    features: [
      "Build compatibility marker",
      "ESP-style overlays",
      "Aim-assist style features",
      "Release-status tracking",
      "Catalog metadata"
    ],
    requirements: [
      "Windows 10 or 11 (64-bit)",
      "Fortnite PC installation",
      "Compatibility changes with game and anti-cheat updates"
    ]
  },

  {
    ...
    features: [
      "Date-based release tracking",
      "ESP-style overlays",
      "Aim-assist style options",
      "Status notes",
    ...
    requirements: [
      "Windows 10 or 11 (64-bit)",
      "Valorant installed",
      "Compatibility changes with Vanguard and game updates"
    ]
  },

  {
    ...
    features: [
      "Aimbot-style targeting",
      "ESP-style overlays",
      "Radar-style information",
      "Release tracking",
      "Compatibility notes"
    ],
    requirements: [
      ...
      "Current game and anti-cheat build"
    ]
  },

  {
    ...
    features: [
      "Season compatibility marker",
      "ESP-style overlays",
      "Aim-assist style options",
      "Release tracking",
      "Catalog changelog metadata"
    ],
    requirements: [
      "Windows 10 or 11 (64-bit)",
      "Apex Legends PC installation",
      "Compatibility depends on anti-cheat and game updates"
    ]
  }
];

export const attachLogos = (items) =>
  items.map((item) => ({
    ...item,
    logo: logo(item.site)
  }));
